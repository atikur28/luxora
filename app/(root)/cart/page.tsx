          ...
          <>
            <div className="col-span-3">
              <Card className="rounded-none">
                <CardHeader className="text-3xl font-medium pb-0">Shopping Cart</CardHeader>
                <CardContent className="p-4">
                  <div className="flex justify-end border-b mb-4 font-medium">Price</div>
                    ...
                    >
                      ...
                      <div className="flex-1 space-y-4">
                        <Link
                          ...
                          className="text-lg hover:no-underline font-medium"
                        >
                          {item.name}
                        </Link>
                        <div>
                  ...
                  <div className="flex justify-end text-lg my-2 font-medium">
                    Subtotal (

...
import AffiliateButton from "./AffiliateButton"; // Client Component
              ...
              <CardContent className="p-4 flex flex-col gap-4">
                ...
                {product.countInStock !== 0 && (
                  <>
                    ...
                    {/* Affiliate Button (Client Component) */}
                    <AffiliateButton productId={product._id} userId={session?.user.id} />
                  </>
                )}
              </CardContent>
            </Card>
